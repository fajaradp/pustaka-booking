        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('member'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="inputPassword" class="col-sm-2 col-form-control" id="password" name="password" placeholder="Password">Password</label>
                        <div>
            ...
            <form action="<?=base_url('member/daftar');?>" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" is="nama" name="nama" placeholder="Nama Lengkap">
                    </div>
                    <div class="form-group">
...
<div class="modal fade" tabindex="-1" id="modalinfo" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <span class="alert alert-message alert-succes">Waktu Pengambilan Buku 1x24 jam dari Booking!!</span>
            </div>
            <div class="modal-footer">
